...
const cm_string_buffer_1 = require("./cm.string-buffer");
/**
...
const convertToString = (input) => {
    ...
    let str;
    if (input instanceof cm_string_buffer_1.CmStringBuffer) {
        try {
            str = input.compileToString();
        }
        catch (error) {
 ...
 */
function anyToString(input) {
    return (0, exports.convertToString)(input).result;
}
